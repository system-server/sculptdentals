...
@push('styles')
  <script src=" {{ asset('js/citas_calendario.js') }} "></script>
@endpush
...
@section('content')
        ...
        <div class="right_col" role="main">
          <div class="">
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Apellidos Nombre" id="search-customer" disabled>
            ...
            <div class="row" id="div-cliente" style="">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Fecha <small>Seleccione el doctor y la fecha para ver su calendario de citas</small></h2>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success btn-disponibilidad">Ver citas</button>
                        </div>
                      </div>
