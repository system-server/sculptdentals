...
@push('styles')
  <script src=" {{ asset('js/citas_calendario_doctor.js') }} "></script>
@endpush
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    ...
                    <input type="text" name="" id="doctor-id" value="{{ Auth::user()->doctor_id }}" hidden>
                    <input type="date" class="form-control" placeholder="" id="quote-date">
                    <span class="input-group-btn">
                      <button class="btn btn-default btn-disponibilidad" type="button">Ver</button>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <p><small>Cambiar el estatus de la cita</small></p>
                    <p><small style="color: red; display: none;" id="quote-msg"></small></p>
                  </div>
                  <div class="modal-body">
                  <form id="quote-form" data-parsley-validate class="form-horizontal form-label-left">
